...
namespace PawMates.Integration.Tests
{
    public class ParentAPITests
    {
        ...
        [Test]
        public async Task ShouldNotAddPetToParentWithoutParentId()
        {
            //Arrange
            int id = 999;
            var expected = HttpStatusCode.NotFound;
        ...
        [Test]
        public async Task ShouldNotDeletePetFromParentWithoutId()
        {
            //Arrange
            int id = 999;
            var expected = HttpStatusCode.NotFound;
        ...
        [Test]
        public async Task ShouldNotDeletePetFromParentWithoutName()
        {
            //Arrange
            int id = 999;
            var expected = HttpStatusCode.NotFound;
        ...
        [Test]
        public async Task ShouldNotDeletePetFromParentWithoutParentName()
        {
            //Arrange
            int id = 999;
            var expected = HttpStatusCode.NotFound;
        ...
        [Test]
        public async Task ShouldNotDeletePetFromParentWithwrongId()
        {
            //Arrange
            int id = 999;
            var expected = HttpStatusCode.NotFound;
